...
class _RmrLoop:
    ...
    this launches a thread, it should probably only be called once; the public facing method to launch this ensures this
    """
    ...
    def thread_is_alive(self):
        """returns whether the loop thread is alive"""
...
def healthcheck_rmr_thread(seconds=30):
    ...
    """
    return _RMR_LOOP.thread_is_alive() and ((time.time() - _RMR_LOOP.last_ran()) < seconds)
