...
def get_policy_instance_status(policy_type_id, policy_instance_id):
    ...
    return _try_func_return(lambda: data.check_instance_status(policy_type_id, policy_instance_id))
...
def delete_policy_instance(policy_type_id, policy_instance_id):
    ...
    def delete_instance_handler():
        ...
        data.set_instance_as_deleted(policy_type_id, policy_instance_id)
