...
a1_counters = Counter('a1_policy', 'Policy type and instance counters', ['counter'])
...
def create_policy_type(policy_type_id):
    ...
    """
    a1_counters.labels(counter='policy_type_creations_total').inc()
...
def delete_policy_type(policy_type_id):
    ...
    """
    a1_counters.labels(counter='policy_type_deletions_total').inc()
...
def create_or_replace_policy_instance(policy_type_id, policy_instance_id):
    ...
    """
    a1_counters.labels(counter='policy_instance_creations_total').inc()
...
def delete_policy_instance(policy_type_id, policy_instance_id):
    ...
    """
    a1_counters.labels(counter='policy_instance_deletions_total').inc()
