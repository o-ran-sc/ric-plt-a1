...
#. Healthcheck
    ...
    curl -v -X GET "http://localhost/a1mediator/a1-p/healthcheck"
...
#. Get all policy types
    ...
    curl -X GET "http://localhost/a1mediator/a1-p/policytypes/"
...
#. Get Policy Type based on policyid
    ...
    curl -s -X GET "http://localhost/a1mediator/a1-p/policytypes/20001" | jq .
...
#. Get all policy instances for a given policy type
    ...
    curl -s -X GET "http://localhost/a1mediator/a1-p/policytypes/20001/policies/" | jq .
...
#. Get policy instance for a policy id and policy instance id
    ...
    curl -s -X GET "http://localhost/a1mediator/a1-p/policytypes/20001/policies/1234" | jq .
...
#. Create Policy type
    ...
    curl -X PUT "http://localhost/a1mediator/a1-p/policytypes/21003/" -H "Content-Type: application/json" -d @policy_schema_ratecontrol.json
...
#. Create policy instance
    ...
    curl -X PUT "http://localhost/a1mediator/a1-p/policytypes/21003/policies/1234" -H "Content-Type: application/json" -d @policy_instance_ratecontrol.json
...
#. Get policy instance status:
    ...
    curl -s -X GET "http://localhost/a1mediator/a1-p/policytypes/21004/policies/1235/status" | jq .
...
#. Delete policy type
    ...
    curl -s -X DELETE "http://localhost/a1mediator/a1-p/policytypes/21004/"

#. Delete policy instance
    
    curl -s -X DELETE "http://localhost/a1mediator/a1-p/policytypes/21004/policies/1234/"

#. A1-EI data delivery for a job id:

    curl -X POST "http://localhost/a1mediator/data-delivery" -H "Content-Type: application/json" -d @a1eidata.json
