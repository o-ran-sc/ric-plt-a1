...
.. code::
    ...
    $ curl -X PUT --header "Content-Type: application/json" --data-raw @create.json "http://a1mediatorip/a1-p/policytypes/20008"
...
.. code::
    ...
    $ curl -X PUT --header "Content-Type: application/json" --data '{"threshold" : 5}' "http://a1mediatorip/a1-p/policytypes/20008/policies/tsapolicy145"
...
.. code::
    ...
    $ curl -v -X GET "http://a1mediatorip/a1-p/healthcheck"
...
.. code::
    ...
    $ curl -X GET "http://a1mediatorip/a1-p/policytypes/"
...
.. code::
    ...
    $ curl -s -X GET "http://a1mediatorip/a1-p/policytypes/20001" | jq .
...
.. code::
    ...
    $ curl -s -X GET "http://a1mediatorip/a1-p/policytypes/20001/policies/" | jq .
...
.. code::
    ...
    $ curl -s -X GET "http://a1mediatorip/a1-p/policytypes/20001/policies/1234" | jq .
...
.. code::
    ...
    $ curl -X PUT "http://a1mediatorip/a1-p/policytypes/21003/" -H "Content-Type: application/json" -d @policy_schema_ratecontrol.json
...
.. code::
    ...
    $ curl -X PUT "http://a1mediatorip/a1-p/policytypes/21003/policies/1234" -H "Content-Type: application/json" -d @policy_instance_ratecontrol.json
...
.. code::
    ...
    $ curl -s -X GET "http://a1mediatorip/a1-p/policytypes/21004/policies/1235/status" | jq .
...
.. code::
    ...
    $ curl -s -X DELETE "http://a1mediatorip/a1-p/policytypes/21004/"

#. Delete policy instance
    
.. code::

    $ curl -s -X DELETE "http://a1mediatorip/a1-p/policytypes/21004/policies/1234/"

#. A1-EI data delivery for a job id:

.. code::

    $ curl -X POST "http://a1mediatorip/data-delivery" -H "Content-Type: application/json" -d @a1eidata.json
