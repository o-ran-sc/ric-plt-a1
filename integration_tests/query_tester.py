...
while True:
    ...
    sbuf = rmr.rmr_alloc_msg(mrc, 4096, payload=json.dumps(pay).encode("utf-8"), gen_transaction_id=True, mtype=20012)
    ...
    if not (post_send_summary["message state"] == 0 and post_send_summary["message status"] == "RMR_OK"):
        ...
        while True:
            ...
            rmr.set_payload_and_length(val, sbuf)  # TODO: extend rmr-python to allow rts to accept this param
            sbuf.contents.mtype = 20011  # TODO: extend rmr-python to allow rts to accept this param
