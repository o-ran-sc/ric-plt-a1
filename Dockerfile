...
FROM nexus3.o-ran-sc.org:10004/bldr-debian-python-nng:1-py3.7

ADD . /tmp

# Install RMr
RUN wget --content-disposition https://packagecloud.io/o-ran-sc/master/packages/ubuntu/xenial/rmr_1.0.34_amd64.deb/download.deb
